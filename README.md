...
your_project_folder/
│
├── turbofan_predictive_maintenance.py  # Main script
...
python turbofan_predictive_maintenance.py
```
...
train_df, test_df, rul_df = load_cmapss_data(dataset_number=2)  # FD002
